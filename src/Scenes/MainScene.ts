...
export default class MainScene extends Phaser.Scene {
	...
	private symbol11!: Phaser.GameObjects.Sprite;
	private symbol10!: Phaser.GameObjects.Sprite;
	private symbol9!: Phaser.GameObjects.Sprite;
	private symbol8!: Phaser.GameObjects.Sprite;
	private symbol7!: Phaser.GameObjects.Sprite;
	private symbol6!: Phaser.GameObjects.Sprite;
	private symbol5!: Phaser.GameObjects.Sprite;
	private symbol4!: Phaser.GameObjects.Sprite;
	private symbol3!: Phaser.GameObjects.Sprite;
	private symbol2!: Phaser.GameObjects.Sprite;
